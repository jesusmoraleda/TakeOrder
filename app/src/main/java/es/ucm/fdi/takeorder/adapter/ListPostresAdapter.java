...
public class ListPostresAdapter extends FirestoreRecyclerAdapter<MenuElement,ListPostresAdapter.ViewHolder> {
     ...
     * @param options
     */
    public ListPostresAdapter(@NonNull FirestoreRecyclerOptions<MenuElement> options, Activity activity) {
        super(options);
                            ...
                            .setPositiveButton("Sí", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id0) {
                                    ...
                                    dbFirestore.collection("mesas").document(id_mesa)
                                            .collection("menu_postres").document(id)
